...
namespace Nettbutikk
{
    class HandleCommand
    {
        ...
        public void RunUI()
        {
            ...
            {
                WriteBands();
                Console.WriteLine("Type \"1\" to look for Band in store");
                Console.WriteLine("Type \"2\" to get a more spesific view");
                Console.WriteLine("Write \"3\" to exit program");

                var command1 = Console.ReadLine();
                if (command1 == "3") return;
                else if (command1 == "1")
                {
        ...
        public Response General()
        {
            ...
            if (command1 == "Artist")
            {
                ...
                var response = LoopTilSuccess(GeneralArtist);
                return response;
            }
            /////////////////////////////////////////////////////////////////////////////////////////
            if (command1 == "Album")
            {
                ...
                var response = LoopTilSuccess(GeneralAlbum);
                return response;
            }
            /////////////////////////////////////////////////////////////////////////////////////////
        ...
        private Response GeneralArtist()
        {
            var command2 = Console.ReadLine();
        CurrentCommand = command2;
            if (command2 == "Instrument")
